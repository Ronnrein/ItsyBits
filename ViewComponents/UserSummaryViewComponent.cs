    ...
    public class UserSummaryViewComponent : ViewComponent {
        ...
        public async Task<IViewComponentResult> InvokeAsync() {
            ApplicationUser user = await _db.Users
                ...
                .Include(u => u.Buildings).ThenInclude(u => u.Animals).ThenInclude(a => a.AnimalUpgrades).ThenInclude(au => au.Upgrade)
                .Include(u => u.Buildings).ThenInclude(b => b.Type)
                .Include(u => u.Buildings).ThenInclude(b => b.BuildingUpgrades).ThenInclude(b => b.Upgrade)
